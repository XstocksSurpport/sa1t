...
export const tokens: Token[] = [
  ...
  {
    id: 10,
    address: '0x65e134b3efb6E65B7C0eF64745FB4f7b1A1cB58A',
    ticker: 'SPCX',
    name: 'sa1tPCX',
    subtitle: 'SPCX',
    price: 0.00004527,
    ...
    logo: '',
    logoBg: '#111111',
    trackInfo: 'sa1tPCX · SpaceX, on a curve. Tracks SPCX 1:1.',
    recentTrades: [{ type: 'buy', wallet: '0x3B9B…91F5', usd: 96, amount: '572M SPCX', time: '1d' }],
  },
  {
    id: 8,
